...
import { searchLocalBusinesses, getFeaturedBusinesses } from '../search/searchService';
import { getAiSuggestions, analyzeImageAndSearch, generateVibeQuery } from '../search/searchInsights';
